...
import { ChefHat, Star, Users, Award, Play } from "lucide-react"
...
export default function HeroSection() {
  return (
    <section className="min-h-screen flex items-center sm:items-end justify-center relative overflow-hidden pb-8 sm:pb-16 lg:pb-20">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 sm:px-6 lg:px-8 w-full pt-16 sm:pt-0">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center mb-6 sm:mb-12 px-2 sm:px-0">
          ...
          <Button variant="outline" className="bg-white/10 backdrop-blur-md text-white border-white/50 hover:bg-white/20 hover:border-white/70 px-4 sm:px-8 py-2 sm:py-4 rounded-full text-sm sm:text-lg transition-all duration-300 flex items-center justify-center gap-2 w-full sm:w-auto">
        ...
        <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
          ...
          <div className="glass rounded-2xl p-4 text-center">
            <ChefHat className="w-8 h-8 text-yellow-300 mx-auto mb-2" />
            <div className="text-2xl font-bold text-white">15+</div>
            <div className="text-white/80 text-sm">Expert Chefs</div>
          </div>
          <div className="glass rounded-2xl p-4 text-center">
